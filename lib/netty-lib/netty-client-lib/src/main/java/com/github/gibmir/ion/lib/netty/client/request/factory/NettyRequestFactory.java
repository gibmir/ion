...
public class NettyRequestFactory implements RequestFactory {
  ...
  public NettyRequestFactory(JsonRpcNettySender defaultJsonRpcNettySender, SocketAddress defaultSocketAddress, Jsonb defaultJsonb, Charset defaultCharset) {
  ...
  @Override
  public <T1, T2, R> Request2<T1, T2, R> twoArg(Class<? extends JsonRemoteProcedure2<T1, T2, R>> procedure, Class<R> returnType) {
    return null;
  }

  @Override
  public <T1, T2, T3, R> Request3<T1, T2, T3, R> threeArg(Class<? extends JsonRemoteProcedure3<T1, T2, T3, R>> procedure, Class<R> returnType) {
    return null;
  }
}
