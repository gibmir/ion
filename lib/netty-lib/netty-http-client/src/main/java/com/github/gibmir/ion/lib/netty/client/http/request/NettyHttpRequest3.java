...
public final class NettyHttpRequest3<T1, T2, T3, R> extends AbstractNettyHttpRequest<NettyHttpRequest3<T1, T2, T3, R>>
  implements Request3<T1, T2, T3, R> {

  public NettyHttpRequest3(final NettyHttpJsonRpcSender defaultJsonRpcSender, final URI defaultUri, final Jsonb jsonb,
   ...
   */
  @Override
  public NettyHttpRequest3<T1, T2, T3, R> jsonb(final Jsonb jsonb) {
   ...
   */
  @Override
  public NettyHttpRequest3<T1, T2, T3, R> charset(final Charset charset) {
    return new NettyHttpRequest3<>(defaultJsonRpcSender, uri, jsonb, charset, jsonRemoteProcedureSignature);
  }
   ...
   */
  @Override
  public NettyHttpRequest3<T1, T2, T3, R> uri(final URI uri) {
    return new NettyHttpRequest3<>(defaultJsonRpcSender, uri, jsonb, charset, jsonRemoteProcedureSignature);
  }
}
