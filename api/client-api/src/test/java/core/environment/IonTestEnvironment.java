...
import com.github.gibmir.ion.api.client.request.callback.ResponseCallback;
...
public class IonTestEnvironment {
  ...
  public static final JsonRemoteProcedure1<TestDto, RequestInitializer<TestDto>> TEST_API_PROCEDURE = JsonRpcClientFactory.singleArg(TestApi.class, TestDto.class);
