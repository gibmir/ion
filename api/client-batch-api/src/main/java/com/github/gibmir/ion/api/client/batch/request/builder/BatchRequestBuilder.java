...
public interface BatchRequestBuilder<B extends BatchRequestBuilder<B>> {
  <R> B add(String id, Class<? extends JsonRemoteProcedure0<R>> jsonRemoteProcedure0, Class<R> returnType);

  <T, R> B addPositional(String id, Class<? extends JsonRemoteProcedure1<T, R>> jsonRemoteProcedure1, T arg, Class<R> returnType);

  <T1, T2, R> B addPositional(String id, Class<? extends JsonRemoteProcedure2<T1, T2, R>> jsonRemoteProcedure2, T1 arg1,
                              T2 arg2, Class<R> returnType);
